...
ActiveRecord::Schema[8.0].define(version: 2025_06_20_174738) do
...
# Could not dump table "workers" because of following StandardError
#   Unknown type 'uuid' for column 'id'


  add_foreign_key "active_storage_attachments", "active_storage_blobs", column: "blob_id"
  add_foreign_key "active_storage_variant_records", "active_storage_blobs", column: "blob_id"
  add_foreign_key "customers", "dictionaries", column: "document_type_id"
  add_foreign_key "user_roles", "roles"
  add_foreign_key "user_roles", "users"
  add_foreign_key "users", "workers"
  add_foreign_key "workers", "dictionaries", column: "document_type_id"
end
